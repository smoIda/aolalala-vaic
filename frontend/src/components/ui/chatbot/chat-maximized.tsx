...
export function ChatMaximized({
  ...
  return createPortal(
    <div className="bg-white-ink text-ink fixed inset-0 z-9999 flex items-start">
      <aside className="flex h-full w-75 shrink-0 flex-col items-start gap-y-10 border-r border-grey-ink bg-white-ink px-2 py-4">
        ...
        <div className="flex w-full flex-col items-start justify-center gap-y-2 px-2">
          ...
          <div className="bg-white-ink flex w-full items-center justify-center gap-x-2 rounded-xl border px-4 py-2">
      ...
      <main className="flex size-full flex-col items-center justify-center">
        <header className="flex w-full items-center justify-end gap-x-4 border-b border-grey-ink px-6 py-4">
          <button
            className="flex cursor-pointer items-center justify-center transition-[scale] hover:scale-120 active:scale-90"
          ...
          <button
            onClick={onClose}
            className="flex size-5 cursor-pointer items-center justify-center transition-[scale] hover:scale-120 active:scale-90"
          >
